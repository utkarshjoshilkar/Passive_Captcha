...
public class ScoreController {
    ...
    public Map<String, Object> calculateScore(@RequestBody UserFeatures features, HttpServletRequest request) {
        try {
            ...
            response.put("score", Math.round(score * 100.0) / 100.0);
            ...
            errorResponse.put("message", "Failed to calculate score: " + e.getMessage());
    ...
    public Map<String, String> healthCheck() {
        ...
        response.put("message", "Passive Captcha Backend is running");
        return response;
    }
